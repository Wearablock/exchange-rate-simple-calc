...
class Currencies {
  ...
  static const List<Currency> all = [
    ...
    Currency(code: 'JPY', name: 'Japanese Yen', nameKo: '일본 엔', symbol: '¥', flag: '🇯🇵', decimalPlaces: 0),
    Currency(code: 'CNY', name: 'Chinese Yuan', nameKo: '중국 위안', symbol: '¥', flag: '🇨🇳'),

    // 아시아
    Currency(code: 'KRW', name: 'South Korean Won', nameKo: '한국 원', symbol: '₩', flag: '🇰🇷', decimalPlaces: 0),
    Currency(code: 'HKD', name: 'Hong Kong Dollar', nameKo: '홍콩 달러', symbol: r'HK$', flag: '🇭🇰'),
    Currency(code: 'TWD', name: 'Taiwan Dollar', nameKo: '대만 달러', symbol: r'NT$', flag: '🇹🇼'),
    Currency(code: 'SGD', name: 'Singapore Dollar', nameKo: '싱가포르 달러', symbol: r'S$', flag: '🇸🇬'),
    Currency(code: 'THB', name: 'Thai Baht', nameKo: '태국 바트', symbol: '฿', flag: '🇹🇭'),
    Currency(code: 'VND', name: 'Vietnamese Dong', nameKo: '베트남 동', symbol: '₫', flag: '🇻🇳', decimalPlaces: 0),
    Currency(code: 'IDR', name: 'Indonesian Rupiah', nameKo: '인도네시아 루피아', symbol: 'Rp', flag: '🇮🇩', decimalPlaces: 0),
    Currency(code: 'MYR', name: 'Malaysian Ringgit', nameKo: '말레이시아 링깃', symbol: 'RM', flag: '🇲🇾'),
    Currency(code: 'PHP', name: 'Philippine Peso', nameKo: '필리핀 페소', symbol: '₱', flag: '🇵🇭'),
    Currency(code: 'INR', name: 'Indian Rupee', nameKo: '인도 루피', symbol: '₹', flag: '🇮🇳'),
    ...
    Currency(code: 'SEK', name: 'Swedish Krona', nameKo: '스웨덴 크로나', symbol: 'kr', flag: '🇸🇪'),
    Currency(code: 'NOK', name: 'Norwegian Krone', nameKo: '노르웨이 크로네', symbol: 'kr', flag: '🇳🇴'),
    Currency(code: 'DKK', name: 'Danish Krone', nameKo: '덴마크 크로네', symbol: 'kr', flag: '🇩🇰'),
    Currency(code: 'PLN', name: 'Polish Zloty', nameKo: '폴란드 즈워티', symbol: 'zł', flag: '🇵🇱'),
    Currency(code: 'CZK', name: 'Czech Koruna', nameKo: '체코 코루나', symbol: 'Kč', flag: '🇨🇿'),
    Currency(code: 'HUF', name: 'Hungarian Forint', nameKo: '헝가리 포린트', symbol: 'Ft', flag: '🇭🇺', decimalPlaces: 0),
    Currency(code: 'RUB', name: 'Russian Ruble', nameKo: '러시아 루블', symbol: '₽', flag: '🇷🇺'),
    Currency(code: 'TRY', name: 'Turkish Lira', nameKo: '터키 리라', symbol: '₺', flag: '🇹🇷'),

    // 아메리카
    Currency(code: 'CAD', name: 'Canadian Dollar', nameKo: '캐나다 달러', symbol: r'C$', flag: '🇨🇦'),
    Currency(code: 'MXN', name: 'Mexican Peso', nameKo: '멕시코 페소', symbol: r'$', flag: '🇲🇽'),
    Currency(code: 'BRL', name: 'Brazilian Real', nameKo: '브라질 헤알', symbol: r'R$', flag: '🇧🇷'),
    Currency(code: 'ARS', name: 'Argentine Peso', nameKo: '아르헨티나 페소', symbol: r'$', flag: '🇦🇷'),
    ...
    Currency(code: 'ZAR', name: 'South African Rand', nameKo: '남아공 랜드', symbol: 'R', flag: '🇿🇦'),
    Currency(code: 'EGP', name: 'Egyptian Pound', nameKo: '이집트 파운드', symbol: 'E£', flag: '🇪🇬'),
  ];
